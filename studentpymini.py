        ...
        while True:
            ...
            if main.lower() == 'repeat':    
                while True:
                    ...
                    Repeat.runAndWait()
                    print(Fore.RESET)
            if main.lower() == "word software":
                print("Ok going to open the word software")
                import word_softwarepymini
            ...
            if main.lower() == "setting":
                ...
                if pys.user.lower() == "student":
                    print("You are already on student mode")
